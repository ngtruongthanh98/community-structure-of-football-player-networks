      ...
      {playerName && (
        <div className="information-box">
          <div className="title">
            ...
            <Button auto color="error" rounded className="remove-btn" onClick={handleRemovePlayer}>
              Remove
            </Button>
          </div>
          ...
          >
            {attributes && attributes.map((item) => <Checkbox value={item}>{item.name}</Checkbox>)}
          </Checkbox.Group>
...
export default FindSimilarPlayersPage;
